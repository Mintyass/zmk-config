...
{
    const char *ble_color = "c9c3b6";
    const char *usb_color = "c9c3b6";
...
int zmk_widget_output_status_init(struct zmk_widget_output_status *widget, lv_obj_t *parent)
{
    ...
    lv_obj_set_style_text_color(widget->transport_label, lv_color_hex(0xC9C3B6), 0);
    lv_obj_align(widget->transport_label, LV_ALIGN_TOP_RIGHT, -10, 10);

    widget->ble_label = lv_label_create(widget->obj);
    lv_obj_set_style_text_color(widget->ble_label, lv_color_hex(0xC9C3B6), 0);
